...
const CreateListing = () => {
    ...
    console.log(currentUser.data._id,"user");
        ...
        <main className="p-3 max-w-4xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex flex-col flex-1 gap-4">
                        ...
                        <button disabled={loading} className="p-3 bg-slate-700 rounded-lg text-white uppercase gap-4 hover:opacity-90 disabled:opacity-80">{loading?"creating...":"Create Listing"}</button>
